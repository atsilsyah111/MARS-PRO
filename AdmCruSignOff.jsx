...
function AdmCruSignOff() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3001/api/SignOffCru", {
      method: "GET",
      headers: {
          ...
          <div className="pt-[179px]">
            <div>
              <ul className="flex justify-center gap-[90px] text-[22px] font-bold ">
                ...
                <li>
                  <a href="/admin-cru-sign-off" className="text-[#1A719C]">
                    Crew Sign-Off
                  </a>
                </li>
              </ul>
