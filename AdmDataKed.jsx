...
function AdmDataKed() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3001/api/DatangKapal", {
      method: "GET",
      headers: {
          ...
          <div className="pt-[179px]">
            <div>
              <ul className="flex justify-center gap-[90px] text-[22px] font-bold ">
                ...
                <li>
                  <a href="/admin-data-ked" className="text-[#1A719C]">
                    Kedatangan
                  </a>
                </li>
                <li>
