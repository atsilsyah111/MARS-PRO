...
const Dept = () => {
  ...
  const handleDataKeberangkatan = async (e) => {
    e.preventDefault();
    const response = await fetch(
      "http://localhost:3001/api/createBerangkatKapal",
      {
        method: "POST",
        headers: {
      ...
      <div className="px-[50px] py-[50px]">
        <div className="flex justify-between items-center absolute gap-[100px]">
          ...
          <div className="px-[100px]">
            <ul className="flex justify-between gap-[185px] text-[24px] font-bold">
              <li>
                <a className="" href="/arrival">
                  Form Kedatangan
                </a>
              </li>
              <li>
                <a className="text-[#1A719C]" href="/departure">
                  Form Keberangkatan
                </a>
              </li>
            </ul>
        ...
        <div>
          <div className="text-[48px] font-bold flex pt-[166px] justify-center gap-[10px]">
            <div>FORM</div>
            <div className="text-[#1A719C]">KEBERANGKATAN</div>
            <div>KAPAL</div>
          </div>
        ...
        <div className="pt-[48px] flex justify-center">
          <div className="flex font-bold text-left text-[20px]">
            <form
              ...
              onSubmit={handleDataKeberangkatan}
            >
              <div className="grid gap-[30px]">
                ...
                <div>
                  <div className="pl-[17px]">Dara Kru Indonesia</div>
                  <div className="pt-[11px]">
                    <input
                      type="text"
                ...
                <div>
                  <div className="pl-[17px]">Jadwal Keberangkatan Kapal</div>
                  <div className="pt-[11px] relative">
                    <input
                      type="date"
                      value={jadwal_keberangkatan}
                      placeholder="Pilih Jadwal Kedatangan Kapal"
                      onChange={(e) => setJadwalKeberangkatan(e.target.value)}
                      className="pl-[17px] pr-[20px] bg-[#83B3CA] placeholder-[#5C5C68] w-[594px] h-[65px] rounded-[20px] appearance-none"
                    />
                  </div>
                </div>
                <div>
                  <div className="pl-[17px]">Tujuan Keberangkatan</div>
                  <div className="pt-[11px] relative">
                    <select
                      className="pl-[17px] bg-[#83B3CA] placeholder-[#5C5C68] w-[594px] h-[65px] rounded-[20px] appearance-none"
                      value={tujuan_keberangkatan}
                      onChange={(e) => setTujuanKeberangkatan(e.target.value)}
                    >
