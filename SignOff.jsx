...
const SignOff = () => {
  ...
  const handleDataSignOff = async (e) => {
    e.preventDefault();
    const response = await fetch("http://localhost:3001/api/createSignOffCru", {
      method: "POST",
      headers: {
        ...
        <div className="flex justify-between items-center absolute gap-[224px]">
          ...
          <div>
            <ul className="flex justify-between gap-[185px] text-[24px] font-bold">
              <li>
                <a className="" href="/sign-on">
                  Sign-On Form
                </a>
              </li>
              <li>
                <a className="text-[#1A719C]" href="/sign-off">
                  Sign-Off Form
                </a>
              </li>
            </ul>
              ...
              <div className="grid gap-[30px]">
                ...
                <div>
                  ...
                  <div className="pt-[11px]">
                    <input
                      type="date"
                      value={tg_rencana_sign_off}
                      onChange={(e) => setRencanaOff(e.target.value)}
